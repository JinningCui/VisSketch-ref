...
class CodeExecutor:
    ...
    def _configure_runtime_dirs(self):
        runtime_root = os.path.join(self.working_dir, ".runtime")
        runtime_dirs = {
            "JUPYTER_CONFIG_DIR": os.path.join(runtime_root, "jupyter_config"),
            "JUPYTER_DATA_DIR": os.path.join(runtime_root, "jupyter_data"),
            "JUPYTER_RUNTIME_DIR": os.path.join(runtime_root, "jupyter_runtime"),
            "IPYTHONDIR": os.path.join(runtime_root, "ipython"),
